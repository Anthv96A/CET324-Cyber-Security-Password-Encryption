...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.signin = function (user) {
        var body = JSON.stringify(user);
        var headers = new Headers({ 'Content-Type': 'application/json' });
        return this.http.post(this.url + 'user/signin', body, { headers: headers }).map(function (data) { return data.json(); }).catch(this.catchException);
    };
    ...
    UserService = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [Http, ErrorService, SuccessService])
    ], UserService);
    return UserService;
}());
export { UserService };
