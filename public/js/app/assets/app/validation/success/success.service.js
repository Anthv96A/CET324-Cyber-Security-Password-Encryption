...
var SuccessService = /** @class */ (function () {
    function SuccessService() {
        this.successOccured = new EventEmitter();
    }
    SuccessService.prototype.handleSuccess = function (msg) {
        var success = new Success(msg.message);
